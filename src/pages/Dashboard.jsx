      ...
      <div className="dash-grid">
                  ...
                  <div key={c.id} className="dash-item">
                    <div className="dash-item-row">
                      ...
                      <span className="dash-tag" style={{
                        background: dif.bg, borderColor: dif.border, color: dif.color,
                      }}>
                        {dif.label}
                      </span>
                    </div>
                    ...
                    <div style={{
                      fontSize: '0.67rem', color: 'var(--muted)', marginTop: 2,
                ...
                <div key={e.id} className="dash-item">
                  <div className="dash-item-row">
                    ...
                    <span className="dash-tag" style={{
                      ...
                      borderColor: 'rgba(212,245,60,0.2)', color: 'var(--accent)',
                    }}>{e.tipo}</span>
                  </div>
        ...
        <div className="dash-card">
          <div className="dash-card-head">
            ...
            <span style={{
              marginLeft: 'auto', fontSize: '0.62rem', color: 'var(--muted)',
